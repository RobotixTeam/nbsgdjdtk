...
<%
    ...
    if (request.getMethod().equalsIgnoreCase("post")) {
        ...
        if (correo != null && username != null && password != null) {
            ...
            String checkQuery = "SELECT correoAl FROM alumnos WHERE correoAl = ?";
            ...
            if (checkResult.next()) {
                ...
                String insertQuery = "INSERT INTO alumnos (correoAl, nombreAl, grupo, boleta, contraseñaAl) VALUES (?, ?, ?, ?, ?)";
                PreparedStatement insertStmt = cn.prepareStatement(insertQuery);
                insertStmt.setString(1, correo);
                insertStmt.setString(2, username);
                insertStmt.setString(3, grupo);
                insertStmt.setInt(4, boleta);
...
<body>
  <div class="container fade-in">
    ...
    <form id="RegistrarForm" method="post">
      ...
      <input type="text" id="grupo" name="grupo" placeholder="Ingresa su grupo" required>
      <label for="boleta">Boleta</label>
      <input type="text" id="boleta" name="boleta" placeholder="Ingresa su boleta" required>
